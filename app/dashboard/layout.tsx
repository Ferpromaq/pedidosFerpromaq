          ...
          <aside className="w-64 bg-white border-r border-zinc-200 flex flex-col h-screen px-4 py-4">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">Sistema de Pedidos</p>
              </div>
            </div>
            ...
            <nav className="flex-1 overflow-y-auto">
              ...
              <div className="mb-5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-zinc-400 text-[15px] opacity-50 cursor-not-allowed select-none">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
